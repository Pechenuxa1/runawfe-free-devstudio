...
public class AiChatLlmConnectorsPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage, PrefConstants {
    private ComboFieldEditor2 fieldEditor;
    private Button addButton;

    public AiChatLlmConnectorsPreferencePage() {
        super(GRID);
    ...
    public void setVisible(boolean visible) {
        ...
        if (visible) {
            fieldEditor.updateData(AiChatLlmConnectorsPreferenceNode.getComboItems());
            fieldEditor.doLoad();
        }
    }
    ...
    public void createFieldEditors() {
        fieldEditor = new AiChatLlmConnectorsPreferencePage.ComboFieldEditor2(P_LLM_CONNECTOR_SELECTED_INDEX, Messages.getString("pref.aichat.connection.llm.selected.label"),
                AiChatLlmConnectorsPreferenceNode.getComboItems(), getFieldEditorParent());
        ...
        addButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                try {
                    ...
                    AiChatLlmConnectorPreferenceNode lastNode = (AiChatLlmConnectorPreferenceNode) children[children.length - 1];
                    AiChatLlmConnectorPreferenceNode node = new AiChatLlmConnectorPreferenceNode(lastNode.getIndex() + 1);
                    llmConnectorsNode.add(node);
                    llmConnectorsNode.saveIndices();
                    AiChatLlmConnectorSettings connectorSettings = AiChatLlmConnectorSettings.createDefault(node.getIndex());
